...
import static net.hudup.regression.em.DefaultMixtureRegressionEM.COMP_NUMBER_FIELD;
import static net.hudup.regression.em.DefaultMixtureRegressionEM.PREV_PARAMS_FIELD;
...
import net.hudup.regression.em.DefaultMixtureRegressionEM;
 ...
 *
 */
public class DefaultMixtureRegression extends AbstractTestingAlg implements Regression, DuplicatableAlg {
	 ...
	 */
	protected DefaultMixtureRegressionEM mixREM = null;
	...
	public Object learn(Object... info) throws Exception {
		...
		DefaultMixtureRegressionEM prevMixREM = null;
		...
		while (true) {
			...
			if (fitness > prevFitness
					 && AbstractRegression.notSatisfy(fitness, prevFitness, threshold)) {
				prevFitness = fitness;
				if (prevMixREM != null)
					prevMixREM.unsetup();
				prevMixREM = mixREM;
	...
	public Alg newInstance() {
		// TODO Auto-generated method stub
		DefaultMixtureRegression mixRegress = new DefaultMixtureRegression();
