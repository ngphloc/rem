 ...
 * 
 */
package net.hudup.regression.ui;
...
public class LargeStatisticsTable extends SortableTable implements MouseListener {
	 ...
	 */
	public static void showDlg(final Component comp, final RM2 rm, boolean modal) {
		if (rm == null || rm.getLargeStatistics() == null || rm.getLargeStatistics().size() == 0) {
		...
		btnExport.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean result = rm.saveLargeStatistics(chooseUri, decimal);
				if (result)
					JOptionPane.showMessageDialog(
						dlg,
